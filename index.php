...
<article>
  ...
  <div class="wrap" id="wrap">
    <ul id="pic">
        <li><img height="350" width="1200" src="images/1.jpeg" alt=""></li>
         <li><img  height="350" width="1200" src="images/2.jpeg" alt=""></li>
        <li><img height="350" width="1200" src="images/3.jpeg" alt=""></li>
  ...
  <div  id="so" >
          <form action="search.php" method="get">
                   <div class="input-group">
                       ...
                       <input style="width: 100%;float: left;" type="text" name="keyword" value="" class="form-control" placeholder="请输入商品名搜索"/>
                       <span class="input-group-addon"><button type="submit"> <span >商品搜索</span></button></span>
                   </div>
           </form>        
  </div>
  ...
  商品列表
   ...
   ?> 
    <div class="tianyi">
        ...
        <p class="orders" style="margin-bottom: 5px;color: red;height: 10px;overflow: hidden;">介绍：<?php echo $v['introduce']; ?></p>
